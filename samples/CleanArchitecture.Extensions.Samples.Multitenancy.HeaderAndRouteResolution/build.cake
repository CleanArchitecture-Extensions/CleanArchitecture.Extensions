...
Task("Build")
    .Does(() => {
        ...
        DotNetBuild("./CleanArchitecture.Extensions.Samples.Multitenancy.HeaderAndRouteResolution.slnx", new DotNetBuildSettings {
...
Task("Test")
    ...
    .Does(() => {
        ...
        DotNetTest("./CleanArchitecture.Extensions.Samples.Multitenancy.HeaderAndRouteResolution.slnx", testSettings);
    });
