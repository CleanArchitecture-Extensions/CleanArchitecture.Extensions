...
Task("Build")
    .Does(() => {
        ...
        DotNetBuild("./CleanArchitecture.Extensions.Core.Logging.Sample.slnx", new DotNetBuildSettings {
...
Task("Test")
    ...
    .Does(() => {
        ...
        DotNetTest("./CleanArchitecture.Extensions.Core.Logging.Sample.slnx", testSettings);
    });
