...
Task("Build")
    .Does(() => {
        ...
        DotNetBuild("./CleanArchitecture.Extensions.Core.Guards.Sample.slnx", new DotNetBuildSettings {
...
Task("Test")
    ...
    .Does(() => {
        ...
        DotNetTest("./CleanArchitecture.Extensions.Core.Guards.Sample.slnx", testSettings);
    });
