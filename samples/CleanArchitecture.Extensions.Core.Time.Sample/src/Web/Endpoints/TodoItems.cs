using CleanArchitecture.Extensions.Core.Time.Sample.Application.Common.Models;
using CleanArchitecture.Extensions.Core.Time.Sample.Application.TodoItems.Commands.CreateTodoItem;
using CleanArchitecture.Extensions.Core.Time.Sample.Application.TodoItems.Commands.DeleteTodoItem;
using CleanArchitecture.Extensions.Core.Time.Sample.Application.TodoItems.Commands.UpdateTodoItem;
using CleanArchitecture.Extensions.Core.Time.Sample.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CleanArchitecture.Extensions.Core.Time.Sample.Application.TodoItems.Queries.GetTodoItemsWithPagination;
