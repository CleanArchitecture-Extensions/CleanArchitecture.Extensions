...
Task("Build")
    .Does(() => {
        ...
        DotNetBuild("./CleanArchitecture.Extensions.Core.Pipeline.Sample.slnx", new DotNetBuildSettings {
...
Task("Test")
    ...
    .Does(() => {
        ...
        DotNetTest("./CleanArchitecture.Extensions.Core.Pipeline.Sample.slnx", testSettings);
    });
