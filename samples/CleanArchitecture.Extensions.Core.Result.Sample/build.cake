...
Task("Build")
    .Does(() => {
        ...
        DotNetBuild("./CleanArchitecture.Extensions.Core.Result.Sample.slnx", new DotNetBuildSettings {
...
Task("Test")
    ...
    .Does(() => {
        ...
        DotNetTest("./CleanArchitecture.Extensions.Core.Result.Sample.slnx", testSettings);
    });
